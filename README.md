...
## JS
- Next.js form with
    - s3 presign-url for authenticated download | email notification with Resend / SendGrid | Zod
    - large file upload displays progress.
    - radix don't have multi select component, so I created check box group.
